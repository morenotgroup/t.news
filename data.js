...
window.TNEWS = {
  ...
  newcomers: [
    { name:'Gabriela Mattar', dept:'T.Youth', role:'Criação', genero:'f', photo:'assets/people/welcomer_gabriela_tyouth.png' },
    { name:'Diego de Souza', dept:'T.Group', role:'Estoque A&B', genero:'m', photo:'assets/people/welcomer_diego_tgroup.png' },
    { name:'Erika Ferreira', dept:'T.Venues', role:'Comercial', genero:'f', photo:'assets/people/welcomer_erika_tvenues.png' },
    { name:'Gabrielle Figueiredo', dept:'T.Group', role:'Facilities', genero:'f', photo:'assets/people/welcomer_gabrielle_tgroup.png' },
    { name:'Ramon Schreier', dept:'T.Brands', role:'Comercial Marcas', genero:'m', photo:'assets/people/welcomer_ramon_tbrands.png' },
  ],
  birthdays: [
    { name:'Gabriel',      firstname:'Brasa',    dept:'Neo Formaturas',  date:'01 de Abril', day:1,  month:4, photo:'assets/people/0104_BDAY_GABRIEL_NEOpng.png' },
    { name:'Gustavo',      firstname:'Gus',     dept:'T.Youth',  date:'01 de Abril', day:1,  month:4, photo:'assets/people/0104_BDAY_GUS_TY.png' },
    { name:'Matheus',firstname:'Mapp',  dept:'Neo Formaturas', date:'01 de Abril', day:1, month:4, photo:'assets/people/0104_BDAY_MATHEUS_NEO.png' },
    { name:'Claudia',firstname:'Clau', dept:'T.Youth', date:'07 de Abril', day:7, month:4, photo:'assets/people/0704_BDAY_CLAU_TY.png' },
    { name:'Bruno',  firstname:'Bruninho',   dept:'Neo Formaturas', date:'10 de Abril', day:10, month:4, photo:'assets/people/1004_BDAY_bruniho_NF.png' },
    { name:'Eduarda', firstname:'Duda',  dept:'T.Youth',  date:'10 de Abril', day:10, month:4, photo:'assets/people/1004_BDAY_duda_ty.png' },
    { name:'Francisco', firstname:'Fran',  dept:'Neo Formaturas',  date:'12 de Abril', day:12, month:4, photo:'assets/people/120426_bday_fran_tyouth.png' },
    { name:'Vinicius', firstname:'Viny',  dept:'T.Youth',  date:'12 de Abril', day:12, month:4, photo:'assets/people/120426_bday_viny_tyouth.png' },
    { name:'Yasmin', firstname:'Yas',  dept:'T.Youth',  date:'14 de Abril', day:14, month:4, photo:'assets/people/140426_bday_yasmin_tyouth.png' }, 
  ],
  menu: {
  ...
  events: [
    { day:23, month:4, year:2026, time:'20h – 22h', title:'Esportes T.Group',             desc:'PLAYBALL UNIDADE 2 - Vôlei de Areia + Futebol Society. Participação gratuita para todos os colaboradores!', type:'gc', ic:'⚽', color:'#7AC231' },
